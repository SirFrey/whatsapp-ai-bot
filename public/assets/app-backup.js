...
import { setStatus, showQR, hideQR, showQRLoading, showError, clearError, updateStats, appendLog, clearLogs, els, apiPost, showLoading, hideLoading } from './ui.js'
...
// Enhanced SSE connection with better error handling and reconnection
...
// Enhanced error handling for SSE connection
es.onerror = (event) => {
